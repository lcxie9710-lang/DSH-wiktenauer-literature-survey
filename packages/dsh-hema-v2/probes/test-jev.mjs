...
import {
  ...
  judgeDecomposition, judgeClaim, passChoice, passBoolean, passScore,
...
ok('C组 on_topic 是 boolean', cQ.on_topic_c1.type === 'boolean')
...
ok('C组：退化断言被独立否决（即使 B 组放过）', dJudge.pass === false && dJudge.onTopic.pass === false,
  `support.pass=${dJudge.support.pass} onTopic.p=${dJudge.onTopic.p}`)
